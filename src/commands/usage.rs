    ...
    let usage = serde_json::json!({
        ...
        "commands": {
            "issues": [
                ...
                {"command": "issues search <query>", "flags": "[--team <team>] [--assignee <me|id>] [--project <project>] [--status <statuses>] [-l, --limit <n=10>]", "description": "Search issues. --assignee accepts \"me\" (authenticated user) or a user ID. --status accepts comma-separated values."},
                {"command": "issues create", "flags": "--title <title> --team <team> [-d, --description <desc>] [-a, --assignee <me|id>] [-p, --priority <1-4>] [--project <project>] [--labels <labels>] [--project-milestone <milestone>] [--cycle <cycle>] [--status <status>] [--parent-ticket <id>]", "description": "Create an issue. --title and --team are required. --assignee accepts \"me\" or a user ID. --labels accepts comma-separated names or IDs."},
                {"command": "issues update <issueId>", "flags": "[-t, --title <title>] [-d, --description <desc>] [-s, --status <status>] [-p, --priority <1-4>] [-a, --assignee <me|id>] [--project <project>] [--labels <labels>] [--label-by <adding|overwriting>] [--clear-labels] [--parent-ticket <id>] [--clear-parent-ticket] [--project-milestone <milestone>] [--clear-project-milestone] [--cycle <cycle>] [--clear-cycle]", "description": "Update an issue. --assignee accepts \"me\" or a user ID. Mutually exclusive: --labels/--clear-labels, --parent-ticket/--clear-parent-ticket, --project-milestone/--clear-project-milestone, --cycle/--clear-cycle."},
